...
def main(model, dataset, nepochs, testArgs):
    ...
    model.train(data=dataset, epochs=nepochs, batch=-1, patience=200, cache=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('model', default=None, help='modelo yolo a ser utilizado')
    ...
    main(args.model, args.dataset, args.epochs, args.test)
